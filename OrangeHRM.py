...
driver.find_element(By.NAME,"username").send_keys("orange")
driver.find_element(By.NAME,"password").send_keys("orange@123")
...
#driver.find_element(By.XPATH,"//input[@placeholder='First Name']").send_keys("Panda");
#driver.find_element(By.XPATH,"//input[@placeholder='Middle Name']").send_keys("tiger");
#driver.find_element(By.XPATH,"//input[@placeholder='Last Name']").send_keys("tigers");
#driver.find_element(By.XPATH,"(//input[@class='oxd-input oxd-input--active'])[2]").send_keys("1111");
...
#driver.find_element(By.XPATH,"(//*[@class='oxd-input oxd-input--active'])[3]").send_keys("pandatigeress");
#driver.find_element(By.XPATH,"(//*[@type='password'])[1]").send_keys("panda@1234");
#driver.find_element(By.XPATH,"(//*[@type='password'])[2]").send_keys("panda@1234");
#driver.find_element(By.XPATH,"//button[@type='submit']").click();
#driver.find_element(By.XPATH,"(//input[@placeholder='yyyy-mm-dd'])[1]").send_keys("2023-05-12");
#driver.find_element(By.XPATH,"(//*[@placeholder='yyyy-mm-dd'])[2]").send_keys("2023-05-12");
...
#driver.find_element(By.XPATH,"(//button[@type='submit'])").click();
#print("This print statement will execute only if the Edit employee Testcase passes");
#driver.close();
...
print("Sucesfully delete employee")
...
driver.find_element(By.XPATH,"(//*[@placeholder='yyyy-mm-dd'])[2]").send_keys("2023-05-14")
